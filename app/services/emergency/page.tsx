...
const STEPS = [
  {
    step: '1',
    title: 'Call Us First',
    body: 'Call (847) 223-1400 immediately. Our team will assess the situation over the phone, give you first-aid guidance, and get your child into the next available same-day slot. Do not wait to see if it gets better.',
    gradientFrom: '#FFE4E6',
    gradientTo: '#FECDD3',
    accentColor: '#E97D63',
  },
