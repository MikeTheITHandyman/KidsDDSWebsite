  ...
  const doctors = [
    {
      ...
      accentText: '#4A90A4',
      bio: tAbout('soniaBio'),
      highlights: [tMeet('sonia_hl0'), tMeet('sonia_hl1'), tMeet('sonia_hl2')],
      href: '/about/meet-the-dentists/dr-sonia-gutierrez',
      delay: 0,
    },
    {
      name: tAbout('daveName'),
      photo: '/brand_assets/index-dr-dave.jpg',
      accentFrom: '#D1FAE5',
      accentTo: '#A7F3D0',
      accentText: '#6BA899',
      bio: tAbout('daveBio'),
      highlights: [tMeet('dave_hl0'), tMeet('dave_hl1'), tMeet('dave_hl2')],
    ...
    },
    {
      ...
      accentText: '#D97706',
      bio: tAbout('saharBio'),
      highlights: [tMeet('sahar_hl0'), tMeet('sahar_hl1'), tMeet('sahar_hl2')],
    ...
    },
    {
      ...
      accentTo: '#DDD6FE',
      accentText: '#7C3AED',
      bio: tAbout('anneAshleyBio'),
      highlights: [tMeet('anneAshley_hl0'), tMeet('anneAshley_hl1'), tMeet('anneAshley_hl2')],
    ...
    <>
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  {isOpen ? tMeet('close') : tMeet('readBio')}
                  <motion.svg
                    width="13"
                    height="13"
                    fill="none"
      ...
      <motion.div
        ...
        style={{
          ...
          padding: '3rem 2rem',
          textAlign: 'center',
          boxShadow: '0 12px 40px rgba(107,75,200,0.22)',
          marginBottom: '2rem',
        }}
      >
        <p
