...
export default async function DrSoniaPage({
  ...
  const credentials = Array.from({ length: 7 }, (_, i) =>
    t(`sonia_cred${i}` as Parameters<typeof t>[0])
  )

  const physicianSchema = {
    '@context': 'https://schema.org',
    '@type': 'Physician',
    name: tAbout('soniaName'),
    medicalSpecialty: 'Pediatric Dentistry',
    description: t('sonia_bio0'),
    image: 'https://www.kidsdds.com/brand_assets/index-dr-sonia.jpg',
    url: 'https://www.kidsdds.com/about/meet-the-dentists/dr-sonia-gutierrez',
      ...
      <div className="mx-auto max-w-5xl px-4">
        ...
        <div className="mb-16 grid items-start gap-12 md:grid-cols-[1fr_1.6fr]">
            ...
            <div style={{ position: 'sticky', top: '6rem', maxWidth: '380px', margin: '0 auto' }}>
              ...
              >
                <Image
                  ...
                  alt={tMeet('headshotAlt', { name: tAbout('soniaName') })}
                  fill
          ...
          <AnimatedSection direction="right" delay={0.12}>
            <span style={{ display: 'inline-block', fontFamily: 'Nunito, sans-serif', fontSize: '0.72rem', fontWeight: 900, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--accent-500)', marginBottom: '0.6rem' }}>
              {t('roleLabel')}
            </span>
            ...
            <div>
              <h3 style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 900, fontSize: '0.78rem', color: 'var(--brand-purple)', marginBottom: '1rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
