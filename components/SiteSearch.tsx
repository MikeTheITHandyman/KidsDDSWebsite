...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { title: 'Sedation Dentistry', description: 'Nitrous oxide and general anesthesiology for anxious or complex cases.', href: '/services/sedation-dentistry', category: 'Services', keywords: 'nitrous oxide laughing gas anesthesia sedation anxious fear calm comfortable' },
  ...
  { title: 'General Anesthesiology', description: 'In-office general anesthesia for comprehensive treatment cases.', href: '/services/general-anesthesiology', category: 'Services', keywords: 'general anesthesia sleep dentistry comprehensive treatment IV sedation' },
  ...
  { title: 'Insurance Information', description: 'We accept Medicaid, CHIP, and most major PPO dental plans.', href: '/for-patients/insurance-info', category: 'For Patients', keywords: 'insurance medicaid chip delta dental aetna cigna guardian billing coverage ppo accepted plans in-network' },
