        ...
        <div className="header-utility-bar-track">
          <div className="header-utility-bar">
            ...
            <motion.a
              ...
              onClick={() => sendGAEvent('call_click', { location: 'header_desktop' })}
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              transition={{ type: 'spring', stiffness: 400, damping: 20 }}
            >
              <span style={{ marginRight: '0.35rem', flexShrink: 0 }}>{t('callLabel')}</span>
              {t('callNumber')}
            </motion.a>
            <motion.a
              ...
              <div className="mobile-nav-inner">
                ...
                <div className="mobile-nav-ctas">
                  ...
                  <a
                    ...
                    onClick={() => { setMenuOpen(false); sendGAEvent('call_click', { location: 'header_mobile' }) }}
                  >
                    <span style={{ marginRight: '0.35rem' }}>{t('callLabel')}</span>
                    {t('callNumber')}
                  </a>
                  <a
                    href="https://www.google.com/maps/dir/?api=1&destination=160+Commerce+Drive,+Grayslake,+IL+60030"
